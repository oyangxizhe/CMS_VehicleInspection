...
namespace CSPSS.BASE_INFO
{
 ...
 (SELECT USER_GROUP FROM USERINFO WHERE USID='" + LOGIN.USID + "'))" + sqlo);
        ...
        private void dgvStateControl()
        {
            ...
            dataGridView1.Columns["联系人"].Width = 80;
            dataGridView1.Columns["供应商编号"].Width = 80;
            dataGridView1.Columns["联系电话"].Width =80;

            dataGridView1.Columns["收款方式"].Width = 80;
            dataGridView1.Columns["收款条件"].Width = 80;
            dataGridView1.Columns["默认联系人"].Width = 80;
            dataGridView1.Columns["传真号码"].Width = 80;
            dataGridView1.Columns["邮政编码"].Width = 80;
            dataGridView1.Columns["EMAIL"].Width =200;
            dataGridView1.Columns["公司地址"].Width =200;
