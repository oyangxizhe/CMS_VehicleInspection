...
namespace CSPSS.USER_MANAGE
{
    public partial class EDIT_RIGHT : Form
    {
        ...
        public DataTable GetTableInfo()
        {
            ...
            dt.Columns.Add("业务审核", typeof(bool));
            dt.Columns.Add("财务审核", typeof(bool));
            dt.Columns.Add("文员审核", typeof(bool));
            return dt;
        }
        #endregion
        #region bind
            ...
            if (dty.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr1 in dty.Rows)
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        {
                            if (dr1["NODE_NAME"].ToString() == "传单作业")
                            {
        ...
        private void dgvStateControl()
        {
            ...
            dataGridView2.Columns["业务审核"].Width = 60;
            dataGridView2.Columns["财务审核"].Width = 60;
            dataGridView2.Columns["文员审核"].Width = 80;
            ...
            dataGridView1.Columns["业务审核"].Width = 70;
            dataGridView1.Columns["财务审核"].Width = 70;
            dataGridView1.Columns["文员审核"].Width = 80;
        }
        #endregion
        ...
        private int return_Voucher_rows_o()
        {
            ...
            for (i = 0; i <dataGridView1 .Rows .Count ; i++)
            {
                ...
                {
                    if (dataGridView1[j,i].Value.ToString ()== "传单作业")
                    {
         ...
         for (int i = 0; i < dataGridView1.Rows.Count; i++)
         {
             ...
             if (i == return_Voucher_rows_o())
             {
                 ...
                 else
                 {
                     ...
                     if (dataGridView1.Rows[i].Cells["业务审核"].EditedFormattedValue.ToString() == "False")
                     {
                     ...
                     if (dataGridView1.Rows[i].Cells["文员审核"].EditedFormattedValue.ToString() == "False")
                     {
                     ...
                     else
                     {
                         ...
                         string v11 = bc.getOnlyString("SELECT PARENT_NODEID FROM RIGHTNAME WHERE NODE_NAME='" + dataGridView1.Rows[i].Cells[1].Value.ToString() + "'");
                         string v12 = bc.getOnlyString("SELECT NODE_NAME FROM RIGHTNAME WHERE NODEID='" + v11 + "'");
                         if (!bc.exists("SELECT * FROM RIGHTLIST WHERE  USID=(SELECT USID FROM USERINFO WHERE UNAME='" + comboBox1.Text + "') AND NODEID='" + v11 + "'") && v11!="0")
                         {
